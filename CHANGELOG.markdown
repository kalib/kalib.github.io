...
- Now based on [mojombo/jekyll](https://github.com/mojombo/jekyll)
...
- Beautiful [Solarized](https://ethanschoonover.com/solarized) syntax highlighting
...
- **Pullquote Tag** Generate beautiful semantic pullquotes (no double data) based on Maykel Loomans's [technique](https://miekd.com/articles/pull-quotes-with-html5-and-css/)
